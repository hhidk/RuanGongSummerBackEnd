...
public class TeamSpaceController {
    ...
    public List<DocPreview> getTeamDocs(@RequestParam("teamID") String teamID, @RequestParam("userID") String userID){
        try {
            return teamSpaceService.getTeamDocs(userID, teamID, 10);
        }
        catch (Exception e){
            e.printStackTrace();
            return null;
